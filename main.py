...
TOKEN = os.getenv('8411283641:AAH4BwXZdYLR2FSQ9X5XwzGSw2vCES7P0us')
OWNER_ID_STR = os.getenv('6468944429')
ADMIN_ID_STR = os.getenv('6468944429')
YOUR_USERNAME = os.getenv('@atercyber')
UPDATE_CHANNEL = os.getenv('@redeyess0')
...
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/redeyess0'
...
"""
    ...
    back_keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="💬 Contact Owner", url=f"https://t.me/@Crazyrana07")],
        [InlineKeyboardButton(text="🏠 Main Menu", callback_data="back_to_main")]
    ])
